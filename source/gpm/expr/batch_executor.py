...
Retained module path: gpm/expr/batch_executor.py
Original source content is intentionally omitted.

Architecture layer: Layer 2 - Provider / Model / Runtime Engines
Architecture role: genetic-programming expression planning and execution surface.
...
- the file belongs to the genetic-programming expression planning and execution surface.
...
- `BatchExecutionResultInfo`

Top-level functions:
- `_coerce_options`
- `_coerce_expression_map`
- `_root`
- `_normalize_expression_map`
- `_resolve_chunk_size`
- `_chunk_items`
- `compute_many_with_info`
- `compute_many`
