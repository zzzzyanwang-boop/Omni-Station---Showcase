# Rust Source-Shaped Surface

This subtree preserves selected Rust crate and file paths from the system architecture. Each `.rs` file is a review placeholder: it keeps the original path shape and replaces implementation code with a role summary, contract notes, and review signals.

The retained Rust paths demonstrate:

- native wire-codec and cross-language fixture boundaries
