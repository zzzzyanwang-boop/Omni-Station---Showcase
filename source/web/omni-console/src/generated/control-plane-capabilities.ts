 ...
 *
 * Original private path: web/omni-console/src/generated/control-plane-capabilities.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: control-plane-capabilities module boundary within the OmniStation research architecture.
 *
