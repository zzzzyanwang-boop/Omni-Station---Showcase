 ...
 *
 * Retained module path: web/omni-console/src/generated/control-plane-capabilities.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: control-plane-capabilities module boundary within the OmniStation research architecture.
 *
