 ...
 *
 * Original private path: web/omni-console/src/generated/ia-pages.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ia-pages module boundary within the OmniStation research architecture.
 *
