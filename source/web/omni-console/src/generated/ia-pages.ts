 ...
 *
 * Retained module path: web/omni-console/src/generated/ia-pages.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ia-pages module boundary within the OmniStation research architecture.
 *
