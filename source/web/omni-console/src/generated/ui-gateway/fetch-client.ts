 ...
 *
 * Original private path: web/omni-console/src/generated/ui-gateway/fetch-client.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: fetch-client module boundary within the OmniStation research architecture.
 *
