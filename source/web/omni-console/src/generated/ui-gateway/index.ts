 ...
 *
 * Retained module path: web/omni-console/src/generated/ui-gateway/index.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: index module boundary within the OmniStation research architecture.
 *
