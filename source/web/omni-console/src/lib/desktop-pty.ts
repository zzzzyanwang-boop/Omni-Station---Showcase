 ...
 *
 * Original private path: web/omni-console/src/lib/desktop-pty.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: desktop-pty module boundary within the OmniStation research architecture.
 *
