 ...
 *
 * Original private path: web/omni-console/src/lib/control-plane-endpoints.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: control-plane-endpoints module boundary within the OmniStation research architecture.
 *
