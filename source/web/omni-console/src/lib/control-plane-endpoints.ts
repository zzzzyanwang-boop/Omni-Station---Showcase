 ...
 *
 * Retained module path: web/omni-console/src/lib/control-plane-endpoints.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: control-plane-endpoints module boundary within the OmniStation research architecture.
 *
