 ...
 *
 * Original private path: web/omni-console/src/lib/ai-insight-contract.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ai-insight-contract module boundary within the OmniStation research architecture.
 *
