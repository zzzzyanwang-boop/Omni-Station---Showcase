 ...
 *
 * Retained module path: web/omni-console/src/lib/ai-insight-contract.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ai-insight-contract module boundary within the OmniStation research architecture.
 *
