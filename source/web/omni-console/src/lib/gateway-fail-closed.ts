 ...
 *
 * Original private path: web/omni-console/src/lib/gateway-fail-closed.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: gateway-fail-closed module boundary within the OmniStation research architecture.
 *
