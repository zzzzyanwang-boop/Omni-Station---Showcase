 ...
 *
 * Original private path: web/omni-console/src/lib/control-plane-contract.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: control-plane-contract module boundary within the OmniStation research architecture.
 *
