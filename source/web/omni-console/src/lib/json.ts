 ...
 *
 * Retained source path: web/omni-console/src/lib/json.ts
 * System layer: Productization Boundary Layer - typed UI client, fail-closed state, and read-model helpers
 * Review role: strict JSON parsing and serialization helper boundary.
 *
 ...
 * - exported functions/components/constants: parseOptionalJsonValue, parseOptionalObject, parseOptionalPrimitiveMap.
