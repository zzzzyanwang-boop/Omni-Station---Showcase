 ...
 *
 * Retained module path: web/omni-console/src/lib/desktop-runtime.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: desktop-runtime module boundary within the OmniStation research architecture.
 *
