 ...
 *
 * Retained module path: web/omni-console/src/lib/gateway-availability.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: gateway-availability module boundary within the OmniStation research architecture.
 *
