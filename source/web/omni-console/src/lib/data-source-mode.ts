 ...
 *
 * Retained module path: web/omni-console/src/lib/data-source-mode.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: data-source-mode module boundary within the OmniStation research architecture.
 *
