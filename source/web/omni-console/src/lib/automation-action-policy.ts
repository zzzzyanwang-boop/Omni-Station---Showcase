 ...
 *
 * Retained module path: web/omni-console/src/lib/automation-action-policy.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: automation-action-policy module boundary within the OmniStation research architecture.
 *
