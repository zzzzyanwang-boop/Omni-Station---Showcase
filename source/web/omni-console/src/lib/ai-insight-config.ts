 ...
 *
 * Retained module path: web/omni-console/src/lib/ai-insight-config.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ai-insight-config module boundary within the OmniStation research architecture.
 *
