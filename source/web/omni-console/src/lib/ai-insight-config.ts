 ...
 *
 * Original private path: web/omni-console/src/lib/ai-insight-config.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ai-insight-config module boundary within the OmniStation research architecture.
 *
