 ...
 *
 * Retained source path: web/omni-console/src/lib/ai-insight-config.ts
 * System layer: Productization Boundary Layer - typed UI client, fail-closed state, and read-model helpers
 * Review role: ai-insight-config source boundary in the retained implementation tree.
 *
 ...
 * - exported functions/components/constants: AI_INSIGHTS_ENABLED.
