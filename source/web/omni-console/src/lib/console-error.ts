 ...
 *
 * Retained module path: web/omni-console/src/lib/console-error.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: console-error module boundary within the OmniStation research architecture.
 *
