 ...
 *
 * Retained source path: web/omni-console/src/lib/console-error.ts
 * System layer: Productization Boundary Layer - typed UI client, fail-closed state, and read-model helpers
 * Review role: error reporting and user-visible failure surface.
 *
 * Structural signals retained from the implementation file:
 * - exported interfaces/types/classes: ConsoleError, ConsoleErrorKind.
 * - exported functions/components/constants: normalizeConsoleError.
 * - local helper functions: normalizeStrictGatewayMessage.
 *
