 ...
 *
 * Original private path: web/omni-console/src/lib/console-error.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: console-error module boundary within the OmniStation research architecture.
 *
