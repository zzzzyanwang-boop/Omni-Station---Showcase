 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui020-data-center.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui020-data-center module boundary within the OmniStation research architecture.
 *
