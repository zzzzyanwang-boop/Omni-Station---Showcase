 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui020-data-center.tsx
 ...
 * - exported functions/components/constants: Ui020DataCenterPage.
 * - local helper functions: normalizeSimpleRows, normalizeArtifactRows, QueryStateAlert, runJob.
 *
 * Reviewable responsibilities:
 * - Owns the ui020-data-center console page boundary and page-level composition.
