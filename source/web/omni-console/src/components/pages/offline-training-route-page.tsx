 ...
 *
 * Original private path: web/omni-console/src/components/pages/offline-training-route-page.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: offline-training-route-page module boundary within the OmniStation research architecture.
 *
