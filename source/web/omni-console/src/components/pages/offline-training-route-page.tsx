 ...
 *
 * Retained source path: web/omni-console/src/components/pages/offline-training-route-page.tsx
 * System layer: Productization Boundary Layer - operator console pages and research workflow surfaces
 * Review role: operator page composition boundary; application route composition boundary.
 *
 ...
 * - exported functions/components/constants: Ui008TrainingRoutePage, Ui027ModelZooRoutePage, Ui028SimIngestionRoutePage, Ui035StrategyLabRoutePage.
 * - local helper functions: describeRunLabel, describeDatasetLabel, describeTemplateLabel, describeStageLabel, buildSummaryItems, buildUi008SurfaceStatusItems, buildUi008FailureModes, buildRouteSurfaceStatusItems, buildRouteFailureModes, buildQuickStartSections, OfflineTrainingRoutePage.
 *
 * Reviewable responsibilities:
 * - Owns the offline training route page console page boundary and page-level composition.
