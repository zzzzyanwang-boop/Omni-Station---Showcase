 ...
 *
 * Retained source path: web/omni-console/src/components/pages/proposal-control-card.tsx
 ...
 * - exported functions/components/constants: ProposalControlCard.
 * - local helper functions: asObject, asString, unwrapData, parseJsonObject, extractProposalId, extractAuditEventId, normalizeProposal, riskTone, riskLabelZh, sanitizeReasonSeed, matrixRuleLabelZh, safetyModeLabel, plus 3 more.
 *
 * Reviewable responsibilities:
 * - Owns the proposal control card console page boundary and page-level composition.
