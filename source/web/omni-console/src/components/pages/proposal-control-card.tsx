 ...
 *
 * Original private path: web/omni-console/src/components/pages/proposal-control-card.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: proposal-control-card module boundary within the OmniStation research architecture.
 *
