 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui008-experiments.tsx
 ...
 * - exported functions/components/constants: Ui008ExperimentsPage.
 * - local helper functions: FormFieldBlock, renderDetailList, asObject, asArray, parseSymbolTokens, toControlState, extractMetricBag, parseModelSuiteEntries, normalizeResearchStageStatus, researchStageLabel, researchStatusLabel, researchStatusTone, plus 50 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui008-experiments console page boundary and page-level composition.
