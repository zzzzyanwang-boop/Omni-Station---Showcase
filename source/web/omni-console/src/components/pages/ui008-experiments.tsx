 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui008-experiments.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui008-experiments module boundary within the OmniStation research architecture.
 *
