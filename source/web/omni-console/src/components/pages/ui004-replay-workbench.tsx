 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui004-replay-workbench.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui004-replay-workbench module boundary within the OmniStation research architecture.
 *
