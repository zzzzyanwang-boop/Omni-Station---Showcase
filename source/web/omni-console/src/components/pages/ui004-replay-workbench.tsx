 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui004-replay-workbench.tsx
 ...
 * - exported functions/components/constants: Ui004ReplayWorkbenchPage.
 * - local helper functions: asObject, asArray, toControlState, parseRows, normalizeReplayRuns, normalizeSummary, normalizeArtifacts, normalizeGlobalArtifacts, extractJobId, extractRunId, buildQualitySeries, buildCompareRows, plus 12 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui004-replay-workbench console page boundary and page-level composition.
