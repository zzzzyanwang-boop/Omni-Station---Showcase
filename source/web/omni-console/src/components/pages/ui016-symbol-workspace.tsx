 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui016-symbol-workspace.tsx
 ...
 * - exported functions/components/constants: Ui016SymbolWorkspacePage.
 * - local helper functions: collectPayloadRows, flattenRoot, normalizeCandles, buildCompareSeries, buildExecutionSeries, normalizeOrderbookRows, normalizeTicks, buildTickSeries, normalizePositionRows, normalizeSymbol, sideLabelZh, orderTypeLabelZh, plus 15 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui016-symbol-workspace console page boundary and page-level composition.
