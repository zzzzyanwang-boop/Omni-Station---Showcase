 ...
 *
 * Retained source path: web/omni-console/src/components/pages/factor-lab-route-page.tsx
 * System layer: Productization Boundary Layer - operator console pages and research workflow surfaces
 * Review role: factor research and governance surface; operator page composition boundary; application route composition boundary.
 *
 ...
 * - exported functions/components/constants: Ui037FactorLabHubRoutePage, Ui024FactorLabRoutePage, Ui029FactorRegistryRoutePage.
 * - local helper functions: buildFactorLabContinuityItems, buildFactorLabSurfaceSpec, FactorLabRoutePage.
 *
 * Reviewable responsibilities:
 * - Owns the factor lab route page console page boundary and page-level composition.
