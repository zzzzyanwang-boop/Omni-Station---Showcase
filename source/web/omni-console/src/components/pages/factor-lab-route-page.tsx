 ...
 *
 * Retained module path: web/omni-console/src/components/pages/factor-lab-route-page.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: factor-lab-route-page module boundary within the OmniStation research architecture.
 *
