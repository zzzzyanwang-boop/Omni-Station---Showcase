 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui012-security.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui012-security module boundary within the OmniStation research architecture.
 *
