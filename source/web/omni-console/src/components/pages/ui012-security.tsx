 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui012-security.tsx
 ...
 * - exported functions/components/constants: Ui012SecurityPage.
 * - local helper functions: asObject, asArray, normalizeStatus, statusTone, toControlState, normalizeGuardrails, normalizeRejects, normalizeSecurityArtifacts, extractCounters, buildCounterSeries, extractJobId.
 *
 * Reviewable responsibilities:
 * - Owns the ui012-security console page boundary and page-level composition.
