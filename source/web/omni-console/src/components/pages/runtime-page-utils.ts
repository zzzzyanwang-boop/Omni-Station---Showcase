 ...
 *
 * Original private path: web/omni-console/src/components/pages/runtime-page-utils.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: runtime-page-utils module boundary within the OmniStation research architecture.
 *
