 ...
 *
 * Retained source path: web/omni-console/src/components/pages/runtime-page-utils.ts
 * System layer: Productization Boundary Layer - operator console pages and research workflow surfaces
 * Review role: runtime status and desktop integration surface; operator page composition boundary.
 *
 * Structural signals retained from the implementation file:
 * - exported interfaces/types/classes: PageModelWidget.
 * - exported functions/components/constants: asString, asNumber, asBoolean, unwrapData, parsePageWidgets, findWidgetById, collectWidgetRows, collectWidgetObject, normalizeStatusText.
 * - local helper functions: asObject, asArray.
 *
 * Reviewable responsibilities:
 * - Owns the runtime page utils console page boundary and page-level composition.
