 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui028-sim-ingestion.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui028-sim-ingestion module boundary within the OmniStation research architecture.
 *
