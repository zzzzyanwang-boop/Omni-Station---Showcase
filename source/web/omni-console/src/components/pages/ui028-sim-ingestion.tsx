 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui028-sim-ingestion.tsx
 ...
 * - exported functions/components/constants: Ui028SimIngestionPage.
 * - local helper functions: FormFieldBlock, asObject, asArray, asBoolean, parseTsMs, normalizeStatus, statusTone, describeSourceReference, describeTargetReference, describeSchemaLabel, describeBackendLabel, describeArtifactLabel, plus 12 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui028-sim-ingestion console page boundary and page-level composition.
