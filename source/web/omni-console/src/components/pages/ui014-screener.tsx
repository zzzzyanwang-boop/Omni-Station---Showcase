 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui014-screener.tsx
 ...
 * - exported functions/components/constants: Ui014ScreenerPage.
 * - local helper functions: flattenRoot, readNumber, readBool, firstText, firstNumber, normalizeRankRows, normalizeScreenRows, buildMetricSeries, snapshotLabel, snapshotAgeSec, summaryCount, collectionCount, plus 8 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui014-screener console page boundary and page-level composition.
