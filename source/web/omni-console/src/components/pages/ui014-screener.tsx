 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui014-screener.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ui014-screener module boundary within the OmniStation research architecture.
 *
