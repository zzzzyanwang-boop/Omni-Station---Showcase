 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui014-screener.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui014-screener module boundary within the OmniStation research architecture.
 *
