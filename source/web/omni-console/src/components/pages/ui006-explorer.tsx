 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui006-explorer.tsx
 ...
 * - exported functions/components/constants: Ui006ExplorerPage.
 * - local helper functions: asObject, asArray, toControlState, parseCatalogSources, parseSchemaRows, parseSegmentRows, parseHashStateRows, parseJournalRows, parseCountRows, parseSeqGapRows, parseQueryTemplates, compactQuery, plus 6 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui006-explorer console page boundary and page-level composition.
