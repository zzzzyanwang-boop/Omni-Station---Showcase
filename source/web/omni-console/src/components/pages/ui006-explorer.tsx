 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui006-explorer.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui006-explorer module boundary within the OmniStation research architecture.
 *
