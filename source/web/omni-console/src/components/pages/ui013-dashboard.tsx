 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui013-dashboard.tsx
 ...
 * - exported functions/components/constants: Ui013DashboardPage.
 * - local helper functions: asObject, asArray, toControlState, extractPublishStatusCounts, extractBacklogRows, extractBackpressureLevel, buildPublishSeries, buildBackpressureSeries, extractJobId.
 *
 * Reviewable responsibilities:
 * - Owns the ui013-dashboard console page boundary and page-level composition.
