 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui013-dashboard.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ui013-dashboard module boundary within the OmniStation research architecture.
 *
