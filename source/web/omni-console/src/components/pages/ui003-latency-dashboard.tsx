 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui003-latency-dashboard.tsx
 ...
 * - exported functions/components/constants: Ui003LatencyDashboardPage.
 * - local helper functions: asObject, asArray, toControlState, normalizeReportRows, normalizeStageRows, buildPercentileSeries, extractJobId, normalizeArtifacts.
 *
 * Reviewable responsibilities:
 * - Owns the ui003-latency-dashboard console page boundary and page-level composition.
