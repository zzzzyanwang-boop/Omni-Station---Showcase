 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui003-latency-dashboard.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui003-latency-dashboard module boundary within the OmniStation research architecture.
 *
