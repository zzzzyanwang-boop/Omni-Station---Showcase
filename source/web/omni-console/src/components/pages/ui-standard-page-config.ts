 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui-standard-page-config.ts
 ...
 * - exported interfaces/types/classes: OperationBinding, StandardPageDefinition, StandardTemplateKind, ContractState.
 * - exported functions/components/constants: STANDARD_PAGE_DEFINITIONS.
 * - local helper functions: defaultPathParamValue, buildDefaultPathParams, createAutoPageDefinition, hasBinding, buildAutoBinding, augmentStandardDefinitions, collectBoundOperationIds.
 *
 * Reviewable responsibilities:
 * - Owns the ui-standard-page-config console page boundary and page-level composition.
