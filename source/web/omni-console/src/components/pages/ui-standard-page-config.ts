 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui-standard-page-config.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui-standard-page-config module boundary within the OmniStation research architecture.
 *
