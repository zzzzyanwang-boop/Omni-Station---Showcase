 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui021-drift-calibration.tsx
 ...
 * - exported functions/components/constants: Ui021DriftCalibrationPage.
 * - local helper functions: asObject, asArray, normalizeStatus, statusTone, toControlState, parseTsMs, extractDriftSnapshot, extractDriftMetricRows, normalizeCalibrationReports, buildDriftSeries, buildCalibrationCurveSeries, buildCompareRows, plus 6 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui021-drift-calibration console page boundary and page-level composition.
