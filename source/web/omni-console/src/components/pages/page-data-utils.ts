 ...
 *
 * Original private path: web/omni-console/src/components/pages/page-data-utils.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: page-data-utils module boundary within the OmniStation research architecture.
 *
