 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui022-alerts-console.tsx
 ...
 * - exported functions/components/constants: Ui022AlertsConsolePage.
 * - local helper functions: normalizeActiveAlerts, extractSummary, buildTrendSeries, severityColor, runJob, triggerAlertsReview, trigger.
 *
 * Reviewable responsibilities:
 * - Owns the ui022-alerts-console console page boundary and page-level composition.
