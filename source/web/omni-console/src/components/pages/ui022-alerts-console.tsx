 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui022-alerts-console.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui022-alerts-console module boundary within the OmniStation research architecture.
 *
