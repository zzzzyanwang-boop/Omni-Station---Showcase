 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui010-release-gate.tsx
 ...
 * - exported functions/components/constants: Ui010ReleaseGatePage.
 * - local helper functions: asObject, asArray, asBoolean, toControlState, parseTsMs, normalizeStatus, statusTone, normalizeReleaseRuns, normalizeGateEvents, normalizeEvidenceArtifacts, buildGateStatusSeries, extractJobId, plus 5 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui010-release-gate console page boundary and page-level composition.
