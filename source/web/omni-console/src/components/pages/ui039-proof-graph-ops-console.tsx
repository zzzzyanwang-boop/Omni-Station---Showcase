 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui039-proof-graph-ops-console.tsx
 ...
 * - exported functions/components/constants: Ui039ProofGraphOpsConsolePage.
 * - local helper functions: asObject, asArray, widgetObject, unwrapPageModelData, asBool, truncate, toneForStatus, typeColor, buildLayout, ProofGraphSvg.
 *
 * Reviewable responsibilities:
 * - Owns the ui039-proof-graph-ops-console console page boundary and page-level composition.
