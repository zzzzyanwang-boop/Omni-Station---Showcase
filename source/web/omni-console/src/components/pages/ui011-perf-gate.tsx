 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui011-perf-gate.tsx
 ...
 * - exported functions/components/constants: Ui011PerfGatePage.
 * - local helper functions: asObject, asArray, normalizeStatus, statusTone, toControlState, parseTsMs, normalizePerfRuns, normalizePerfChecks, normalizePerfArtifacts, buildPerfSeries, extractJobId, extractRunId, plus 1 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui011-perf-gate console page boundary and page-level composition.
