 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui002-policy-gate.tsx
 * System layer: Productization Boundary Layer - operator console pages and research workflow surfaces
 * Review role: operator policy and action-gating boundary; operator page composition boundary.
 *
 ...
 * - exported functions/components/constants: Ui002PolicyGatePage.
 * - local helper functions: asObject, asArray, toControlState, normalizeResult, normalizeGateRows, buildResultDistribution, stringifyPayload, triggerDownload, extractJobId.
 *
 * Reviewable responsibilities:
 * - Owns the ui002-policy-gate console page boundary and page-level composition.
