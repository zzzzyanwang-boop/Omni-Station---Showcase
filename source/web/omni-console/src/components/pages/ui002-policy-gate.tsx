 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui002-policy-gate.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui002-policy-gate module boundary within the OmniStation research architecture.
 *
