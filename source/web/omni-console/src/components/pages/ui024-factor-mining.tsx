 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui024-factor-mining.tsx
 ...
 * - exported functions/components/constants: Ui024FactorMiningPage.
 * - local helper functions: FormFieldBlock, asObject, asArray, asBoolean, normalizeStatus, statusTone, normalizeRunType, factorRunTypeLabel, parseTsMs, toControlState, parseJsonObject, extractJobId, plus 14 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui024-factor-mining console page boundary and page-level composition.
