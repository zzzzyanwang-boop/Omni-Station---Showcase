 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui032-reports-hub.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui032-reports-hub module boundary within the OmniStation research architecture.
 *
