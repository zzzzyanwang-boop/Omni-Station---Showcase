 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui032-reports-hub.tsx
 ...
 * - exported functions/components/constants: Ui032ReportsHubPage.
 * - local helper functions: formatAmount, describeExportKind, summarizeReportTab, renderStructuredDetails, normalizeOrderRows, normalizeFillRows, normalizePnlRows, normalizeAuditRows, buildTcaRows, runExport.
 *
 * Reviewable responsibilities:
 * - Owns the ui032-reports-hub console page boundary and page-level composition.
