 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui025-time-sync.tsx
 ...
 * - exported functions/components/constants: Ui025TimeSyncPage.
 * - local helper functions: asObject, asArray, parseTsMs, normalizeStatus, statusTone, parseJsonObject, extractJobId, extractSlaSnapshot, normalizeProcessRows, normalizeProbeRows, extractHistoryPoints, buildTimeSyncSeries, plus 4 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui025-time-sync console page boundary and page-level composition.
