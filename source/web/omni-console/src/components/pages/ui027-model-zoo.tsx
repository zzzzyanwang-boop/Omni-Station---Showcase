 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui027-model-zoo.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: ui027-model-zoo module boundary within the OmniStation research architecture.
 *
