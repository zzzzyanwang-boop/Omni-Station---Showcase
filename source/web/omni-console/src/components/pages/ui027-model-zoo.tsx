 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui027-model-zoo.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui027-model-zoo module boundary within the OmniStation research architecture.
 *
