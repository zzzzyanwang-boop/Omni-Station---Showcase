 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui034-settings-admin-help.tsx
 ...
 * - exported functions/components/constants: Ui034SettingsAdminHelpPage.
 * - local helper functions: AdminFieldBlock, extractHealthState, extractRuntimeMode, extractWhoAmI, extractRole, parsePluginTemplates, parsePluginManifests, computeDrillScoreRows, averageScore, parseTrustedSources, describeUserLabel, describeRoleSummary, plus 16 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui034-settings-admin-help console page boundary and page-level composition.
