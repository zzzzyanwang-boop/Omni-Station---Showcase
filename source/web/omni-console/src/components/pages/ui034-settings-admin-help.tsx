 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui034-settings-admin-help.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui034-settings-admin-help module boundary within the OmniStation research architecture.
 *
