 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui007-rulebook.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui007-rulebook module boundary within the OmniStation research architecture.
 *
