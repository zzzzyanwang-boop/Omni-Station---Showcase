 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui007-rulebook.tsx
 ...
 * - exported functions/components/constants: Ui007RulebookPage.
 * - local helper functions: asObject, asArray, toControlState, parseReportRows, parseRuleChecks, parseArtifactRows, buildReportSeries, extractJobId, extractRunId, runReconcileJob.
 *
 * Reviewable responsibilities:
 * - Owns the ui007-rulebook console page boundary and page-level composition.
