 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui017-expert-workbench.tsx
 ...
 * - exported functions/components/constants: Ui017ExpertWorkbenchPage.
 * - local helper functions: normalizeExpertRows, normalizeDqDiffRows, buildExpertScoreSeries, runJob.
 *
 * Reviewable responsibilities:
 * - Owns the ui017-expert-workbench console page boundary and page-level composition.
