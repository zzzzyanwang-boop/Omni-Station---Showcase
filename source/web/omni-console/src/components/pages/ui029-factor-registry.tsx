 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui029-factor-registry.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui029-factor-registry module boundary within the OmniStation research architecture.
 *
