 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui026-inference-control.tsx
 ...
 * - exported functions/components/constants: Ui026InferenceControlPage.
 * - local helper functions: asObject, asArray, parseTsMs, normalizeStatus, statusTone, toControlState, normalizeActorRows, normalizeEndpointRows, extractCounterSnapshot, extractCounterHistory, buildCounterSeries, extractActiveManifest, plus 1 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui026-inference-control console page boundary and page-level composition.
