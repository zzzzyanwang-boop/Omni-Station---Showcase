 ...
 *
 * Retained module path: web/omni-console/src/components/pages/ui026-inference-control.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Architecture role: ui026-inference-control module boundary within the OmniStation research architecture.
 *
