 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui033-news-events.tsx
 ...
 * - exported functions/components/constants: Ui033NewsEventsPage.
 * - local helper functions: parseSymbolsFromText, normalizeWatchlistNames, normalizePositionSymbols, normalizeNewsFeedRows, normalizeWatchlistSymbols, humanizeEventLabel, normalizeAlertNewsRows, normalizeMarketEventRows, rankImportance, importanceLabel, relatedLabel, scopeLabelZh, plus 3 more.
 *
 * Reviewable responsibilities:
 * - Owns the ui033-news-events console page boundary and page-level composition.
