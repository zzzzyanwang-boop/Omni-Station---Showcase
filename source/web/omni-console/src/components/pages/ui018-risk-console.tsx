 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui018-risk-console.tsx
 ...
 * - exported functions/components/constants: Ui018RiskConsolePage.
 * - local helper functions: normalizeGateRows, normalizeRejectReasons, buildRejectSeries, normalizeAccountSummary, normalizePositionRows, runJob.
 *
 * Reviewable responsibilities:
 * - Owns the ui018-risk-console console page boundary and page-level composition.
