 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui005-trace-tree.tsx
 ...
 * - exported functions/components/constants: Ui005TraceTreePage.
 * - local helper functions: asObject, asArray, toControlState, parseReportRows, parseDetailNodes, parseArtifacts, extractJobId, extractReportId, buildTimelineSpans, renderNodeDetails, renderTraceArtifactDetails, runDumpTree.
 *
 * Reviewable responsibilities:
 * - Owns the ui005-trace-tree console page boundary and page-level composition.
