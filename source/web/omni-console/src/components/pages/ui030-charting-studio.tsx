 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui030-charting-studio.tsx
 ...
 * - exported functions/components/constants: Ui030ChartingStudioPage.
 * - local helper functions: parseSymbolsText, normalizeCandles, markerFromReplay, saveSnapshot.
 *
 * Reviewable responsibilities:
 * - Owns the ui030-charting-studio console page boundary and page-level composition.
