 ...
 *
 * Original private path: web/omni-console/src/components/pages/ui030-charting-studio.tsx
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Research Governance & Operations
 * Public-safe role: ui030-charting-studio module boundary within the OmniStation research architecture.
 *
