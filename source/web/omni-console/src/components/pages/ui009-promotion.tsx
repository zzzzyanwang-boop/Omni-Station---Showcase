 ...
 *
 * Retained source path: web/omni-console/src/components/pages/ui009-promotion.tsx
 ...
 * - exported functions/components/constants: Ui009PromotionPage.
 * - local helper functions: asObject, asArray, toControlState, stringifyScalar, parseManifestRows, parseCandidateRows, parseArtifactRows, buildCandidateSeries, buildDiffRows, extractJobId, runReadinessBundle.
 *
 * Reviewable responsibilities:
 * - Owns the ui009-promotion console page boundary and page-level composition.
