 ...
 *
 * Original private path: web/omni-console/e2e/support/fixture-session.ts
 * Original source content is intentionally omitted.
 *
 * Architecture layer: Layer 5 - Console Surface
 * Public-safe role: fixture-session module boundary within the OmniStation research architecture.
 *
