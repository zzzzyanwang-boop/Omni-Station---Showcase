...
Retained module path: omni_station/research/data/catalog_adapter.py
Original source content is intentionally omitted.

Architecture layer: Layer 1 - Data / Compute / Artifact Infrastructure
Architecture role: adapter boundary and anti-corruption layer.
...
Top-level classes:
- `CatalogQuery`
- `NautilusCatalogAdapter`

Top-level functions:
- `_try_import_parquet_catalog`
- `_bars_to_df`
