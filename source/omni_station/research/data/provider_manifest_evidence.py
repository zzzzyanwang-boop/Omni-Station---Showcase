...
Retained module path: omni_station/research/data/provider_manifest_evidence.py
Original source content is intentionally omitted.

Architecture layer: Layer 1 - Data / Compute / Artifact Infrastructure
Architecture role: manifest and content-addressed artifact handling.
...
Top-level classes:
- `ProviderManifestEvidence`

Top-level functions:
- `load_provider_manifest_evidence`
- `provider_manifest_evidence_from_manifest`
- `provider_manifest_signature_seed`
- `_load_report`
- `_mapping`
- `_observation_level`
