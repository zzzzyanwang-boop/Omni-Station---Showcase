...
Retained module path: omni_station/research/features/license_formula_review_contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: feature/factor foundry and external projection surface.
...
- the file belongs to the feature/factor foundry and external projection surface.
...
Top-level classes:
- `LicenseFormulaReviewContract`

Top-level functions:
- `license_formula_review_contracts`
- `license_formula_review_contract_for_source`
- `local_license_formula_review_specs`
- `build_license_formula_review_contract_report`
- `write_license_formula_review_contract_schema`
- `_safe_identifier`
