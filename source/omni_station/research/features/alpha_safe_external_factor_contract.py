...
Retained module path: omni_station/research/features/alpha_safe_external_factor_contract.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: factor lifecycle and governance; typed contract and invariant enforcement.
...
Top-level functions:
- `build_alpha_safe_external_factor_contract`
- `forbidden_external_factor_columns`
- `validate_external_factor_declaration`
- `write_alpha_safe_external_factor_contract_schema`
