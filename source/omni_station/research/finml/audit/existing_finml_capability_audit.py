...
Retained module path: omni_station/research/finml/audit/existing_finml_capability_audit.py
Original source content is intentionally omitted.

Architecture layer: Layer 2 - Provider / Model / Runtime Engines
Architecture role: leakage, forbidden-feature, and evidence admissibility checks.
