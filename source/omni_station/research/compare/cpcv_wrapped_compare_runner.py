...
Retained module path: omni_station/research/compare/cpcv_wrapped_compare_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: challenger/default comparison and champion eligibility gates.

Implementation highlights visible at architecture-review level:
- combinatorial purged cross-validation contract surface.
