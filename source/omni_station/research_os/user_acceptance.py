...
Retained module path: omni_station/research_os/user_acceptance.py
...
Top-level functions:
- `run_user_acceptance`
- `run_kernel_user_journeys`
- `run_application_user_journeys`
- `run_engine_user_journeys`
- `run_route_archetype_user_journeys`
- `run_lightweight_business_probes`
- `forbidden_heavy_inventory`
