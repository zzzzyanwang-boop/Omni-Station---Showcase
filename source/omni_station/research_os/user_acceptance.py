...
Original private path: omni_station/research_os/user_acceptance.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: user acceptance module boundary within the OmniStation research architecture.
