...
Retained module path: omni_station/research_os/data_plane/cache.py
Original source content is intentionally omitted.

Architecture layer: Layer 1 - Data / Compute / Artifact Infrastructure
Architecture role: manifested data access, fold-local reads, checkpoints, cache policy, and writer contracts.

Implementation highlights visible at architecture-review level:
- deterministic cache lifecycle and stale artifact invalidation.
