...
Retained module path: omni_station/research_os/factor_evidence/controlled_incrementality.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: factor identity, incrementality, risk adjustment, and secondary audit contracts.
