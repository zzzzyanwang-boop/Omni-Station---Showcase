...
Original private path: omni_station/research_os/factor_evidence/controlled_incrementality.py
Original source content is intentionally omitted.

Architecture layer: Layer 1 - Research Control Plane
Public-safe role: factor identity, incrementality, risk adjustment, and secondary audit contracts.
