...
Retained module path: omni_station/research_os/candidate_feature_label/contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: candidate, feature, and label contract surface for Research OS runs.
