...
Retained module path: omni_station/research_os/engines/contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 2 - Provider / Model / Runtime Engines
Architecture role: Research OS reusable engine wrapper surface.
...
- the file belongs to the Research OS reusable engine wrapper surface.
...
- `require_engine_broad_production_ready`
- `engine_classification_records`
