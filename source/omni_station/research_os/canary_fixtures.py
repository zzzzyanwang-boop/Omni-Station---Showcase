...
Original private path: omni_station/research_os/canary_fixtures.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Public-safe role: canary fixtures module boundary within the OmniStation research architecture.
