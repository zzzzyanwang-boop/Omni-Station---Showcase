...
Retained module path: omni_station/research_os/event_graph/contracts.py
...
Top-level classes:
- `CausalTimeGraphViolation`

Top-level functions:
- `build_event_record`
- `build_availability_record`
- `build_feature_lineage_node`
- `validate_feature_lineage_at_decision`
- `build_label_interval_record`
- `validate_purge_embargo_label_intervals`
- `build_universe_revision_manifest`
- `build_provider_revision_record`
- `build_causal_time_graph_packet`
- `write_causal_time_graph_packet`
