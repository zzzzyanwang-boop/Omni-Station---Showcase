...
Retained module path: omni_station/research_os/model_training/contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: model training, OOF, and sequence governance surface.
...
- the file belongs to the model training, OOF, and sequence governance surface.
...
Top-level classes:
- `ModelTrainingViolation`
- `ModelFamilyRegistry`
- `ModelRegistry`

Top-level functions:
- `build_model_family_spec`
- `build_training_run_spec`
- `build_fold_training_artifact`
- `build_oof_evidence_binding`
- `build_calibration_artifact`
- `build_model_registry_entry`
- `build_model_training_readiness_gate`
- `build_model_training_packet`
- `write_model_training_packet`
