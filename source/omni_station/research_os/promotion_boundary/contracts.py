...
Retained module path: omni_station/research_os/promotion_boundary/contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: freeze, parity, and promotion contracts for Research OS promotion and freeze boundary control.
