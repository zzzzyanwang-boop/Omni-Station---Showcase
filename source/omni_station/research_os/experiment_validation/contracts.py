...
Retained module path: omni_station/research_os/experiment_validation/contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: experiment validation contracts and admission controls.
