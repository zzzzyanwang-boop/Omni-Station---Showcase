...
Original private path: omni_station/apps/ui_gateway/offline_research_contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: offline research contracts module boundary within the OmniStation research architecture.
