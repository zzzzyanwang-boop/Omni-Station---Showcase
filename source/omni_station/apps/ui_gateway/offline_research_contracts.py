...
Retained module path: omni_station/apps/ui_gateway/offline_research_contracts.py
...
- `resolve_research_brief_schema_path`
- `resolve_research_brief_default_path`
- `load_research_brief_schema`
- `load_research_brief_default`
- `coerce_iso_utc`
- `sha256_json`
- `build_time_policy`
- `build_tick_alignment_policy`
