...
Retained module path: omni_station/apps/ui_gateway/job_watchdog_runtime.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: job state and progress control; runtime posture or execution boundary.
...
Top-level functions:
- `resolve_worker_watchdog_limits`
- `run_cmd_with_progress_poll`
