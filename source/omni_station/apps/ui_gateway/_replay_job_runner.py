...
Retained module path: omni_station/apps/ui_gateway/_replay_job_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: offline replay or economic simulation; job state and progress control; bounded task runner or orchestration entrypoint.
