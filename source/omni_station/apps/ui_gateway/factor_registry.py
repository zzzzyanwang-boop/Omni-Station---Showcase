...
Original private path: omni_station/apps/ui_gateway/factor_registry.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: factor registry module boundary within the OmniStation research architecture.
