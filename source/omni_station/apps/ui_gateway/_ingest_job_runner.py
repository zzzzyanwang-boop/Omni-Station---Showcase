...
Original private path: omni_station/apps/ui_gateway/_ingest_job_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role:  ingest job runner module boundary within the OmniStation research architecture.
