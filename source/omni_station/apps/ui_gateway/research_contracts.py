...
Retained module path: omni_station/apps/ui_gateway/research_contracts.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: research contracts module boundary within the OmniStation research architecture.
