...
Original private path: omni_station/apps/ui_gateway/factor_registry_ops.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: factor registry ops module boundary within the OmniStation research architecture.
