...
Retained module path: omni_station/apps/ui_gateway/factor_registry_ops.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: factor registry ops module boundary within the OmniStation research architecture.
