...
Retained module path: omni_station/apps/ui_gateway/artifacts.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: artifacts module boundary within the OmniStation research architecture.
