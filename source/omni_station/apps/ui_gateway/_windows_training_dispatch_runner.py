...
Original private path: omni_station/apps/ui_gateway/_windows_training_dispatch_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role:  windows training dispatch runner module boundary within the OmniStation research architecture.
