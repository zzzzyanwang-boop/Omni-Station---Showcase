...
Retained module path: omni_station/apps/ui_gateway/_windows_training_dispatch_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: bounded task runner or orchestration entrypoint.
...
- `_copy_if_exists`
- `_tail_text`
- `_worker_log_tail_from_result`
- `_inject_worker_log_tails_into_manifest`
- `resolve_ui_gateway_jobs_root_from_runs_root`
- `repair_manifest_execution_env_artifacts`
- `main`
