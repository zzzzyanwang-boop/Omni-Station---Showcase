...
Retained module path: omni_station/apps/ui_gateway/app_factor_registry_routes.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: app factor registry routes module boundary within the OmniStation research architecture.
