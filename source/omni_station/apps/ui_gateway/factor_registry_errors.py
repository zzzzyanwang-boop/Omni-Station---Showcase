...
Original private path: omni_station/apps/ui_gateway/factor_registry_errors.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: factor registry errors module boundary within the OmniStation research architecture.
