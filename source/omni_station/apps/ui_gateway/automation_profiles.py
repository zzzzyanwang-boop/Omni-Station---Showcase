...
Retained module path: omni_station/apps/ui_gateway/automation_profiles.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: automation profiles module boundary within the OmniStation research architecture.
