...
Original private path: omni_station/apps/ui_gateway/market_data_archive.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: market data archive module boundary within the OmniStation research architecture.
