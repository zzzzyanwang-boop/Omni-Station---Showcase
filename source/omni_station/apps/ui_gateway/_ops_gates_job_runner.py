...
Retained module path: omni_station/apps/ui_gateway/_ops_gates_job_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role:  ops gates job runner module boundary within the OmniStation research architecture.
