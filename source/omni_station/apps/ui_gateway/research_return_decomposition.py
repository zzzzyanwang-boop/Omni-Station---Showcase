...
Original private path: omni_station/apps/ui_gateway/research_return_decomposition.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: research return decomposition module boundary within the OmniStation research architecture.
