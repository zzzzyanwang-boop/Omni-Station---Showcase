...
Original private path: omni_station/apps/ui_gateway/domain_support.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: domain support module boundary within the OmniStation research architecture.
