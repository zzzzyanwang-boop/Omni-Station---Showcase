...
Retained module path: omni_station/apps/ui_gateway/domain_support.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: domain support module boundary within the OmniStation research architecture.
