...
Retained module path: omni_station/apps/ui_gateway/progress_watchdog_policy.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: progress telemetry and watchdog behavior; policy binding and permission control.
...
Top-level functions:
- `_normalize_token`
- `classify_progress_phase_profile`
- `resolve_progress_watchdog_policy`
- `is_heartbeat_only_signal`
- `is_effective_progress_signal`
