...
Retained module path: omni_station/apps/ui_gateway/research_handoff.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: research handoff module boundary within the OmniStation research architecture.
