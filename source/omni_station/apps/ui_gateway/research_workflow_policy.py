...
Retained module path: omni_station/apps/ui_gateway/research_workflow_policy.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: policy binding and permission control.
...
Top-level functions:
- `apply_closed_loop_model_suite_defaults`
- `inject_research_workflow_closed_loop_defaults`
- `enforce_canonical_prepare_entry`
