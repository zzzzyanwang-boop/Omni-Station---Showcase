...
Original private path: omni_station/apps/ui_gateway/research_workflow_policy.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: research workflow policy module boundary within the OmniStation research architecture.
