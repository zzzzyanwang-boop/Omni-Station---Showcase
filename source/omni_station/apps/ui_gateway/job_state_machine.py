...
Original private path: omni_station/apps/ui_gateway/job_state_machine.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: job state machine module boundary within the OmniStation research architecture.
