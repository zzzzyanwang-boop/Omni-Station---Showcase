...
Original private path: omni_station/apps/ui_gateway/contract_registry.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: contract registry module boundary within the OmniStation research architecture.
