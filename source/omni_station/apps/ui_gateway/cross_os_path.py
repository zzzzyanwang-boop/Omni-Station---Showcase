...
Original private path: omni_station/apps/ui_gateway/cross_os_path.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: cross os path module boundary within the OmniStation research architecture.
