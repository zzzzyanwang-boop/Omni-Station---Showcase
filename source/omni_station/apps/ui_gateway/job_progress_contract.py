...
Original private path: omni_station/apps/ui_gateway/job_progress_contract.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: job progress contract module boundary within the OmniStation research architecture.
