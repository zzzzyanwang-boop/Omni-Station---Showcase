...
Retained module path: omni_station/apps/ui_gateway/gui_smoke.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: gui smoke module boundary within the OmniStation research architecture.
