...
Original private path: omni_station/apps/ui_gateway/contract_values.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: contract values module boundary within the OmniStation research architecture.
