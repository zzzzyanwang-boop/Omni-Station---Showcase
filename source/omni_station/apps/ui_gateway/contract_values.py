...
Retained module path: omni_station/apps/ui_gateway/contract_values.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: contract values module boundary within the OmniStation research architecture.
