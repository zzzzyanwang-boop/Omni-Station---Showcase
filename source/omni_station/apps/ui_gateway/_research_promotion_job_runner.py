...
Retained module path: omni_station/apps/ui_gateway/_research_promotion_job_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: job state and progress control; bounded task runner or orchestration entrypoint.
...
Top-level functions:
- `_research_contracts_module`
- `build_evidence_bundle`
- `upsert_run_context`
- `write_attribution_report`
- `write_promotion_candidate`
- `write_run_contract`
- `resolve_schema_canonical_dataset`
- `get_factor_registry_service`
- `market_data_archive_status`
