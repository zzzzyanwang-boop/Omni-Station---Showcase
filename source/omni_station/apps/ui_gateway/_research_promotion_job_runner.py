...
Original private path: omni_station/apps/ui_gateway/_research_promotion_job_runner.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role:  research promotion job runner module boundary within the OmniStation research architecture.
