...
Retained module path: omni_station/apps/ui_gateway/app_route_dispatch.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: app route dispatch module boundary within the OmniStation research architecture.
