...
Original private path: omni_station/apps/ui_gateway/layers/policy/evidence_schema_policy.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: evidence schema policy module boundary within the OmniStation research architecture.
