...
Retained module path: omni_station/apps/ui_gateway/market_data_events.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: market data events module boundary within the OmniStation research architecture.
