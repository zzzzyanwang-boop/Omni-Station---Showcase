...
Original private path: omni_station/apps/ui_gateway/market_data_events.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: market data events module boundary within the OmniStation research architecture.
