...
Original private path: omni_station/apps/ui_gateway/domain_factor_registry.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Public-safe role: domain factor registry module boundary within the OmniStation research architecture.
