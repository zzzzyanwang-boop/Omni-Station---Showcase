...
Retained module path: omni_station/apps/ui_gateway/factor_registry_validation_tasks.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: factor lifecycle and governance; registry/catalog state and lookup semantics; validation and blocker generation.
...
Top-level classes:
- `FactorRegistryValidationTasksMixin`
