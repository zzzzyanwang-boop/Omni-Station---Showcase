...
Retained module path: omni_station/apps/ui_gateway/factor_registry_serialization.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: factor registry serialization module boundary within the OmniStation research architecture.
