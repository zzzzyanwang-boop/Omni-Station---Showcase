...
Retained module path: omni_station/apps/ui_gateway/factor_registry_governance_lifecycle.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: factor registry governance lifecycle module boundary within the OmniStation research architecture.
