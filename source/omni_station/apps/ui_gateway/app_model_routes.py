...
Retained module path: omni_station/apps/ui_gateway/app_model_routes.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - Research Governance & Operations
Architecture role: app model routes module boundary within the OmniStation research architecture.
