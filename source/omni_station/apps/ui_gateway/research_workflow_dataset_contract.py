...
Original private path: omni_station/apps/ui_gateway/research_workflow_dataset_contract.py
Original source content is intentionally omitted.

Architecture layer: Layer 5 - UI Gateway and Read Models
Public-safe role: research workflow dataset contract module boundary within the OmniStation research architecture.
