...
Retained module path: omni_station/research_foundry/lakehouse/table_manifest.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: table manifest module boundary within the OmniStation research architecture.
