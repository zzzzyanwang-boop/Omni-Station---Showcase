...
Top-level functions:
- `build_local_lakehouse_transaction_log`
- `build_lakehouse_compaction_proof`
- `build_lakehouse_retention_proof`
- `build_legacy_reader_retirement_proof`
- `build_local_lakehouse_engine_proof`
- `validate_local_lakehouse_engine_proof`
