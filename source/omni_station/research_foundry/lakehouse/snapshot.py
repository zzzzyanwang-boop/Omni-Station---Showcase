...
Retained module path: omni_station/research_foundry/lakehouse/snapshot.py
...
Top-level functions:
- `build_table_snapshot_manifest`
- `build_table_snapshot_log`
- `resolve_table_snapshot`
- `build_time_travel_read_contract`
- `_validate_snapshot_hash`
- `_validate_snapshot_log_hash`
