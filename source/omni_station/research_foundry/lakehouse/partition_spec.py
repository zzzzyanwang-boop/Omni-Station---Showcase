...
Original private path: omni_station/research_foundry/lakehouse/partition_spec.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Research Engine and Evidence Foundry
Public-safe role: partition spec module boundary within the OmniStation research architecture.
