...
Retained module path: omni_station/research_foundry/lakehouse/partition_spec.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: partition spec module boundary within the OmniStation research architecture.
