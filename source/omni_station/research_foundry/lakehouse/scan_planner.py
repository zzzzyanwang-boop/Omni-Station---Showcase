...
Original private path: omni_station/research_foundry/lakehouse/scan_planner.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Public-safe role: scan planner module boundary within the OmniStation research architecture.
