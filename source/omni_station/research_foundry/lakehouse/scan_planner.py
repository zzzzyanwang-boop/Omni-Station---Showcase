...
Retained module path: omni_station/research_foundry/lakehouse/scan_planner.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: planning and execution-shape selection.
...
Top-level classes:
- `ManifestOnlyArtifactResolver`
- `SnapshotManifestArtifactResolver`

Top-level functions:
- `artifact_scan_preflight_blockers`
- `forbid_glob_discovery_in_decision_path`
- `_is_large_table_artifact`
- `_validate_bounded_scan_request`
- `_validate_snapshot_manifest_hash`
