...
Retained module path: omni_station/research_foundry/external_factors/setup_allocation.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: external factor semantic joins, frozen subsets, and production proof boundaries.
