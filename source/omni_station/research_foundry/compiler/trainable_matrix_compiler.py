...
Retained module path: omni_station/research_foundry/compiler/trainable_matrix_compiler.py
Original source content is intentionally omitted.

Architecture layer: Layer 4 - Research Applications
Architecture role: feature, label, sidecar, and trainable-matrix compilation boundaries.
