...
Original private path: omni_station/research_foundry/runtime/performance_gate.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Research Engine and Evidence Foundry
Public-safe role: performance gate module boundary within the OmniStation research architecture.
