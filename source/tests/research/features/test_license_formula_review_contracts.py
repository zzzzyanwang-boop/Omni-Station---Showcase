...
Architecture role: contract test and no-bypass verification surface.
...
Top-level functions:
- `test_license_formula_review_contracts_exclude_long_horizon_context_sources_from_short_horizon_catalog`
