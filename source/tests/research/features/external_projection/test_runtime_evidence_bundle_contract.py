...
Retained module path: tests/research/features/external_projection/test_runtime_evidence_bundle_contract.py
Original source content is intentionally omitted.

Architecture layer: Layer 3 - Evidence / Contract / DAG Kernel
Architecture role: runtime posture or execution boundary; typed contract and invariant enforcement.
...
Top-level functions:
- `test_runtime_evidence_bundle_contract`
