...
Retained module path: tests/research/features/external_projection/test_cs_bottleneck_evidence_packet_contract.py
...
Top-level functions:
- `test_cs_bottleneck_evidence_packet_contract`
