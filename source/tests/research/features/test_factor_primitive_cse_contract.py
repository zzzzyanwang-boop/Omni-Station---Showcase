...
Retained module path: tests/research/features/test_factor_primitive_cse_contract.py
...
Top-level functions:
- `test_primitive_cse_contract_blocks_unallowlisted_shadow_output`
- `test_primitive_cse_contract_allows_equal_allowlisted_output`
- `test_primitive_cse_contract_blocks_nonfinite_policy_drift`
