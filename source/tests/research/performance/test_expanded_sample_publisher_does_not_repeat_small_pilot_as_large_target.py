...
Original private path: tests/research/performance/test_expanded_sample_publisher_does_not_repeat_small_pilot_as_large_target.py
Original source content is intentionally omitted.

Architecture layer: Validation Evidence - Test Contracts
Public-safe role: physical source resolution, compatibility, benchmarks, and materialization performance controls.
