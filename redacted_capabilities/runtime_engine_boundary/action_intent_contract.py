...
Capability: Execution safety boundary
Public-safe role: Action intent contract before any executable route.

Implementation highlights visible from the public architecture:
- score-to-action separation.
- intent validation.
- offline-only admissibility.
