...
Redacted capability area: evidence_contract_dag_kernel
Research OS layer: Layer 3 - Evidence / Contract / DAG Kernel
Capability: Leakage audit
Public-safe role: Forbidden feature and future-data linter.

Implementation highlights visible from the public architecture:
- fail-closed feature blacklist.
- label-derived field detection.
