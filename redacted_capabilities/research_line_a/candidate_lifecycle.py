...
Capability: Alpha / factor research line
Public-safe role: Candidate lifecycle from hypothesis intake to frozen review packet.

Implementation highlights visible from the public architecture:
- hypothesis-to-candidate state model.
- candidate admission and rejection ledger.
- lineage-preserving evidence envelope.
