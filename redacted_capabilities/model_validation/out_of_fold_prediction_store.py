...
Redacted capability area: model_validation
Capability: OOF prediction lifecycle
Public-safe role: OOF prediction store contract.

Implementation highlights visible from the public architecture:
- fold-local write ownership.
- schema-hash and content-hash binding.
- blocked raw-score promotion.
