...
Redacted capability area: performance_native_paths
Capability: Native materialization
Public-safe role: Native candidate materialization boundary.

Implementation highlights visible from the public architecture:
- hot-loop extraction.
- bounded native-kernel interface.
- Python-loop avoidance target.
